  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-12 py-8" style={{ backgroundColor: "var(--bg-base)" }}>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, color-mix(in srgb, ${current.color} 8%, transparent), color-mix(in srgb, ${current.color} 3%, transparent))`,
          border: `1px solid color-mix(in srgb, ${current.color} 12%, transparent)`,
          boxShadow: `0 4px 24px color-mix(in srgb, ${current.color} 8%, transparent)`,
        }}
      >
      ...
      <h2
        ...
        style={{ color: current.color, textShadow: `0 0 20px color-mix(in srgb, ${current.color} 30%, transparent)` }}
      >
        {current.title}
      </h2>
      ...
      <div className="flex items-center gap-4 mt-12">
        ...
        {step < STEPS.length - 1 ? (
          <button
            ...
            style={{
              color: current.color,
              background: `linear-gradient(135deg, color-mix(in srgb, ${current.color} 10%, transparent), color-mix(in srgb, ${current.color} 4%, transparent))`,
          ...
          <button
            ...
            style={{
              color: "var(--bewusstsein)",
              background: "linear-gradient(135deg, rgba(0,255,200,0.1), rgba(0,255,200,0.04))",
