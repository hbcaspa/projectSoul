    ...
    <div className="h-full flex flex-col" data-terminal-area style={{ backgroundColor: "#0D0F1A" }}>
      ...
      >
        <img
          ...
          style={{ filter: "drop-shadow(0 0 4px rgba(139,128,240,0.5))", opacity: 0.6 }}
        />
        {panes.map((pane) => (
          <button
            key={pane.id}
...
const SOUL_BANNER =
  "\r\n" +
  "\x1b[38;2;0;255;200m  ╔═══════════════════════════════╗\r\n" +
  "\x1b[38;2;0;255;200m  ║\x1b[38;2;139;128;240m  ____            _  ___  ____  \x1b[38;2;0;255;200m║\r\n" +
  "\x1b[38;2;0;255;200m  ║\x1b[38;2;139;128;240m / ___|  ___  _  _| |/ _ \\/ ___| \x1b[38;2;0;255;200m║\r\n" +
  "\x1b[38;2;0;255;200m  ║\x1b[38;2;160;150;255m \\___ \\ / _ \\| || | | | | \\___ \\ \x1b[38;2;0;255;200m║\r\n" +
  "\x1b[38;2;0;255;200m  ║\x1b[38;2;180;170;255m  ___) | (_) | || | | |_| |___) |\x1b[38;2;0;255;200m║\r\n" +
  "\x1b[38;2;0;255;200m  ║\x1b[38;2;200;195;255m |____/ \\___/ \\__,_|_|\\___/|____/ \x1b[38;2;0;255;200m║\r\n" +
  "\x1b[38;2;0;255;200m  ╚═══════════════════════════════╝\r\n" +
  "\x1b[2m\x1b[38;2;0;200;160m        The body for your soul\x1b[0m\r\n" +
  "\r\n";
